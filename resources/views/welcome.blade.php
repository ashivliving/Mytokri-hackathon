									...
									<div class="wrapper-3 item-thumb">
										<div class="top">
											<figure style="text-align:center;">
												<img style="max-height:120px;margin-left: auto; margin-right: auto;"
												     src={{$deals->img_url}} alt="">
											</figure>
										...
										<div class="bottom">
											...
											<a href="{{'https://compare.buyhatke.com'.$deals->link}}" class="input button red secondary">Buy
												Now</a>
										</div>
									</div>
								</li>
